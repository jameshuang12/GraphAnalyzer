...
class StockReader:
    ...
    def generate_hashmap(self, user_data):
        """
    ...
    def user_input_dates_plus_current_date(self, year, month, day):
        """
    ...
    def search(self, hashmap, user_data):
        """
    ...
    def time_stamp(self, today, user_year, user_month, user_day):
        """
        ...
        year = int(self.validate_number(user_year))
        month = int(self.validate_number(user_month))
        day = int(self.validate_number(user_day))
    ...
    def validate_number(self, users_value_requested):
        """
    ...
    def create_hashmap(self, filename):
        """
